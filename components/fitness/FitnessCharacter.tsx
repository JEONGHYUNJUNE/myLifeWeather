...
export function FitnessCharacter({
  ...
  return (
    <svg
      ...
      className={`fitness-character ${celebrating ? "fitness-character-celebrating" : ""}`}
    >
      ...
      <g className="fitness-character-body">
        {active && (
          <path
        ...
        >
          ...
          <path
            ...
            stroke={shirt}
          />
          <g className="fitness-character-arm-left">
            <path
              d={
                active
                  ? "M190 101 L170 122 L156 108"
                  : "M187 103 L163 125 L145 102"
              }
              fill="none"
              stroke="#e6b68b"
              strokeWidth="13"
            ...
            {!active && (
              <g stroke="#354e43" strokeWidth="7">
                <path d="M128 96 h34" />
                <path d="M131 85 v23 M158 85 v23" strokeWidth="10" />
              </g>
            )}
          </g>
          <g className="fitness-character-arm-right">
            <path
              d={
                active
                  ? "M231 103 L248 122 L264 106"
                  : "M234 103 L255 125 L275 102"
              }
              fill="none"
              stroke="#e6b68b"
              strokeWidth="13"
            ...
            {!active && (
              <g stroke="#354e43" strokeWidth="7">
                <path d="M258 96 h34" />
                <path d="M261 85 v23 M288 85 v23" strokeWidth="10" />
              </g>
            )}
          </g>
          ...
          <path
            d={
              celebrating
                ? "M195 67 Q199 61 203 67 M215 67 Q219 61 223 67"
                : "M199 65 v2 M219 65 v2"
            }
          />
          <path
            d={
              celebrating || stage >= 3
                ? "M202 76 Q210 87 219 76 Z"
                : "M204 77 Q210 82 217 76"
            }
            fill={celebrating || stage >= 3 ? "#fffaf0" : "none"}
            strokeWidth="2"
          />
        </g>
      </g>
