...
export const trip = {
  ...
  australianOpen: {
    ...
    tickets: [
      { label: "Men's Quarterfinal · Night", date: "Jan 26", min: 430000, max: 500000, selected: true, seat: "13·16구역 중간열 · 14·15가 50만 원 이하면 우선 선택" },
      { label: "Men's Quarterfinal · Day", date: "Jan 27", min: 280000, max: 350000, selected: true, seat: "그늘 우선 53·54구역 앞줄 · 차선 52·55 또는 20~24" },
      { label: "Men's Semifinal · Night", date: "Jan 29", min: 550000, max: 650000, selected: true, seat: "14·15구역 8~20열 · 차선 5·6 또는 13·16구역" },
...
export const tripDays: TripDay[] = [
  ...
  { day:6,date:"2027-01-27",city:"Melbourne",title:"Men's Quarterfinal · Day",summary:"그늘 좌석으로 체력을 지키는 두 번째 경기",activities:[a("ao-qf-day","10:30","Rod Laver Arena","그늘과 관람 각도를 함께 보면 53·54구역 앞줄이 1순위예요. 없으면 52·55 또는 20~24구역 앞줄을 보고, 햇빛이 강한 27~31구역은 피합니다.","주간 세션","CBD에서 15분","트램",650000,5,[-37.8216,144.9785],img.tennis)]},
