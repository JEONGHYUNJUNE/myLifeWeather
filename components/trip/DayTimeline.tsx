...
export function DayTimeline() {
  ...
  return <section id="itinerary" className="py-20">
    <div className="mb-10 flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><p className="text-[11px] font-bold uppercase tracking-[.18em] text-[#d06950]">10-day itinerary</p><h2 className="mt-2 font-display text-4xl font-bold tracking-tight">하루씩 펼쳐보는 여행</h2><Link href="/australia-2027/schedule" className="mt-4 inline-flex items-center gap-2 rounded-full bg-[#0b5360] px-4 py-2.5 text-xs font-bold text-white"><Clock size={14}/> 시간별 일정표 열기</Link></div><p className="max-w-sm text-sm leading-6 text-black/50">시드니를 먼저 여행하고 준준결승 전날 멜버른에 들어와요. 귀국편이 시드니 출발이라 30일 저녁 다시 시드니로 이동합니다.</p></div>
