...
export const trip = {
  ...
  australianOpen: {
    ...
    tickets: [
      { label: "Men's Quarterfinal · Night", date: "Jan 26", min: 500000, max: 650000, selected: true, seat: "1순위 14·15구역 앞쪽 8~20열" },
      { label: "Men's Quarterfinal · Day", date: "Jan 27", min: 400000, max: 550000, selected: true, seat: "13~16구역 또는 2층 중앙 맨 앞줄" },
      { label: "Men's Semifinal · Night", date: "Jan 29", min: 550000, max: 750000, selected: true, seat: "14·15구역 우선, 예산 초과 시 12·17구역" },
  ...
  budget: [
    { id: "ao", label: "Australian Open · 남자 경기 3세션 2인", amount: 3700000, color: "#f4b942" },
...
export const tripDays: TripDay[] = [
  ...
  { day:5,date:"2027-01-26",city:"Melbourne",title:"Men's Quarterfinal · Night",summary:"좋은 좌석으로 즐기는 첫 Australian Open",activities:[a("ao-qf","17:00","Rod Laver Arena","오후 5시 입장 후 Night Session 관람. 14·15구역 앞쪽 8~20열을 우선으로 찾아요.","야간 세션","CBD에서 15분","트램",1150000,5,[-37.8216,144.9785],img.tennis)]},
  { day:6,date:"2027-01-27",city:"Melbourne",title:"Men's Quarterfinal · Day",summary:"낮 세션에서 두 번째 남자 준준결승 관람",activities:[a("ao-qf-day","10:30","Rod Laver Arena","11시 입장 후 Day Session 관람. 전날 Night Session 뒤라 오전 동선은 느슨하게 잡아요.","주간 세션","CBD에서 15분","트램",950000,5,[-37.8216,144.9785],img.tennis)]},
  ...
  { day:8,date:"2027-01-29",city:"Melbourne",title:"Men's Semifinal · Night",summary:"이동 걱정 없이 남자 준결승에 집중",activities:[a("ao-sf","17:00","Rod Laver Arena","남자 단식 준결승 Night Session. 실제 선수 배정은 전날 발표되는 오더를 확인해요.","야간 세션","CBD에서 15분","트램",1300000,5,[-37.8216,144.9785],img.tennis)]},
