...
export default function TennisPage() { return <main className="min-h-screen bg-[#f7f2e8] pb-28 text-[#163b41]"><TripSubpageHeader eyebrow="Australian Open 2027" title="테니스 관람 계획" description="1월 26일 Night 45구역과 1월 29일 Day 54구역, Ground Pass까지 한 화면에서 확인해요."/><div className="mx-auto -mt-8 max-w-6xl px-4 sm:px-8"><AustralianOpenCard/></div><TripBottomNav/></main>; }
